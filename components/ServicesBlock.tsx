    ...
    <BentoCard className="aspect-square px-4 py-4">
      <div className="flex flex-col justify-between h-full">
        <div className="flex flex-col justify-start items-start h-full gap-5">
          <h2 className="text-xl md:text-2xl font-moranga tracking-wide">
          ...
          <div className="flex flex justify-around w-full gap-5">
            <div className="flex flex-col justify-start h-[80%] gap-2">
              ...
              <h3 className="text-sm md:text-md font-sf-pro-medium text-gray-400">
                Product Engeering
              </h3>
              <p className="text-md md:text-lg font-sf-pro text-black dark:text-white">
                Turning 0 → 1 concepts into shipping products
              </p>
            </div>
            ...
            <div className="flex flex-col justify-start h-[80%] gap-2">
              ...
              <p className="text-md md:text-lg font-sf-pro text-black dark:text-white">
                Intelligent automation & RAG pipelines
              </p>
            </div>
          </div>
        </div>
        <Button
          ...
          startContent={
            <>
              <ArrowUpRightIcon className="dark:hidden" size={12} />
              <ArrowUpRightWhiteIcon className="hidden dark:block" size={12} />
            </>
          }
          variant="ghost"
        >
