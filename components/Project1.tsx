...
export const Project1 = () => {
    return (
        <BentoCard className="aspect-[1/2] bg-[#378AFF] relative overflow-hidden h-auto">
            <div className="absolute top-1/2 left-1/2 -translate-x-[42%] -translate-y-[-40%] w-40 h-40 bg-[#4AC0B6] rounded-full z-0" />
