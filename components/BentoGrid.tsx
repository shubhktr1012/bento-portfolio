  ...
  return (
    <div className="mx-auto max-[739px]:w-[376px] min-[740px]:max-[1199px]:w-[762px]">
      ...
      >
        <div
          key="bio"
          className={`select-none transition-all duration-500 ${isBlockActive("bio") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <BioBlock />
        </div>
        <div
          key="location"
          className={`select-none transition-all duration-500 ${isBlockActive("location") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <LocationBlock />
        </div>
        <div
          key="project1"
          className={`select-none transition-all duration-500 ${isBlockActive("project1") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <Project1 />
        </div>
        <div
          key="project2"
          className={`select-none transition-all duration-500 ${isBlockActive("project2") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <Project2 />
        </div>
        <div
          key="music"
          className={`select-none transition-all duration-500 ${isBlockActive("music") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <MusicBlock />
        </div>
        <div
          key="website1"
          className={`select-none transition-all duration-500 ${isBlockActive("website1") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <Website1 />
        </div>
        <div
          key="status"
          className={`select-none transition-all duration-500 ${isBlockActive("status") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <StatusBlock />
        </div>
        <div
          key="socials"
          className={`select-none transition-all duration-500 ${isBlockActive("socials") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <SocialsBlock />
        </div>
        <div
          key="toggle"
          className={`select-none transition-all duration-500 ${isBlockActive("toggle") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <ToggleBlock />
        </div>
        <div
          key="website2"
          className={`select-none transition-all duration-500 ${isBlockActive("website2") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <Website2 />
        </div>
        <div
          key="services"
          className={`select-none transition-all duration-500 ${isBlockActive("services") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <ServicesBlock />
        </div>
        <div
          key="website3"
          className={`select-none transition-all duration-500 ${isBlockActive("website3") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <Website3 />
        </div>
        <div
          key="focus"
          className={`select-none transition-all duration-500 ${isBlockActive("focus") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <FocusBlock />
        </div>
        <div
          key="backToTop"
          className={`select-none transition-all duration-500 ${isBlockActive("backToTop") ? "opacity-100 grayscale-0" : "opacity-40 grayscale"}`}
        >
          <BackToTopBlock />
        </div>
      </ResponsiveGridLayout>
