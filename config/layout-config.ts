...
export const layouts = {
  lg: [
    ...
    { i: "music", x: 0, y: 1, w: 1, h: 1 },
    { i: "website1", x: 0, y: 3, w: 1, h: 1 },
    { i: "status", x: 1, y: 3, w: 1, h: 1 },
    { i: "socials", x: 1, y: 2, w: 1, h: 1 },
    { i: "toggle", x: 3, y: 2, w: 1, h: 1 },
    { i: "website2", x: 3, y: 3, w: 1, h: 1 },
    { i: "services", x: 0, y: 4, w: 2, h: 1 },
    { i: "website3", x: 0, y: 5, w: 1, h: 1 },
    { i: "focus", x: 2, y: 4, w: 1, h: 1 },
    { i: "backToTop", x: 1, y: 4, w: 1, h: 1 },
  ],
  md: [
